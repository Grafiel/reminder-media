...
export class BookController {
  ...
  async create(@Req() request: Request, @Body() createBookDTO: CreateBookDTO) {
    ...
    book.publication_year = createBookDTO.publicationYear || 0;
    book.cover_image_url = createBookDTO.coverImageUrl || '';
    book.isbn = createBookDTO.isbn || '';
    // book.publication_year = createBookDTO.publicationYear;
    // book.cover_image_url = createBookDTO.coverImageUrl;
    // book.isbn = createBookDTO.isbn;
